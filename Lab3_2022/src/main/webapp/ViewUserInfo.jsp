...
<div style="display:flex;margin-top:20px" >
  ...
  <div style="margin-top:20px;display:block">
  	...
  	<div style=padding-left:20px>
  		<button type="button" style="height:35px;width:90px;font-size:10px;padding-top:0px;padding-bottom:0px;padding-left:0px;padding-right:0px" class="editUser w3-button w3-white w3-border  w3-round-large"><i class="fa fa-user fa-2x"></i> &nbsp;Edit</button>
